...
// 公共函数
void CMachineObjArcEll::MovetEllipseCenter(ObjPoint point)
{
	m_EllipseCenter = point;
	ReSizeBound();
}

void CMachineObjArcEll::MoveArcStart(ObjPoint point)
{
...
void CMachineObjArcEll::MoveArcEnd(ObjPoint point)
{
...
void CMachineObjArcEll::SetEllipseXradius(double radius)
{
	m_EllipseXRadius = radius;
	ReSizeBound();
}

void CMachineObjArcEll::SetEllipseRatio(double ratio)
{
	m_EllipseRatio = ratio;
	ReSizeBound();
}

void CMachineObjArcEll::SetStartAndEndRadian(double radian1, double radian2)
{
	m_ArcStartRadian = radian1;
	m_ArcEndRadian = radian2;
	if ((m_ArcEndRadian - m_ArcStartRadian) > 2 * M_PI)
		m_ArcStartRadian += 2 * M_PI;
	else if ((m_ArcStartRadian - m_ArcEndRadian) > 2 * M_PI)
		m_ArcEndRadian += 2 * M_PI;
	if (m_ArcStartRadian < 0 && m_ArcEndRadian < 0)
	{
		m_ArcStartRadian += 2 * M_PI;
