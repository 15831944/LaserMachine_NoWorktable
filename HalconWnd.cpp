...
CHalconWnd::CHalconWnd()
{
	...
	//hv_CameraParameters[1] = 0.0692008;
	//hv_CameraParameters[2] = -1760.59;
	//hv_CameraParameters[3] = 2.20714e-006;
	//hv_CameraParameters[4] = 2.2e-006;
	//hv_CameraParameters[5] = 1258.06;
	//hv_CameraParameters[6] = 1044.85;
	//hv_CameraParameters[7] = 2592;
	//hv_CameraParameters[8] = 1944;
	//hv_CameraPose.Clear();
	//hv_CameraPose[0] = 0.00152023;
	//hv_CameraPose[1] = -0.000238585;
	//hv_CameraPose[2] = 1.86236;
	//hv_CameraPose[3] = 4.03902;
	//hv_CameraPose[4] = 0.117794;
	//hv_CameraPose[5] = 356.315;
	//hv_CameraPose[6] = 0;
